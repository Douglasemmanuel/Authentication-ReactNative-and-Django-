...
export const userAuthApi = createApi({
  ...
  endpoints: (builder) => ({
   //to register a user
    ...
    //to enable a user change his password
    ...
    //to enable our user  get reset link in therir email when they reset their password
    ...
    //to enable our user reset therir password if they have forgotten their password
